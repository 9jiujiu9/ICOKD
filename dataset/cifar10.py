...
def get_cifar10_dataloaders_two(opt, batch_size=128, num_workers=8, is_instance=False):
    """
    cifar 10
    """
    data_folder = get_data_folder()
    ...
    train_transform.transforms.append(transforms.Normalize((0.4914, 0.4822, 0.4465),
