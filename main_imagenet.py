...
parser.add_argument('--alpha', type=float, default=1, help='weight balance for VCL')
parser.add_argument('--gamma', type=float, default=1, help='weight balance for Soft VCL')
parser.add_argument('--beta', type=float, default=1, help='weight balance for ICL')
...
parser.add_argument('--nce_k', default=8192, type=int, help='number of negative samples for NCE')
...
trainloader, testloader, n_data, n_data_classes = get_dataloader_sample(data_folder=args.data,
