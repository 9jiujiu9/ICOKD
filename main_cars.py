...
from dataset.cars196 import get_cars196_dataloaders_sample
...
parser.add_argument('--feat-dim', default=64, type=int, help='feature dimension')
...
if args.dataset == 'cars':
        trainloader, testloader, n_data = get_cars196_dataloaders_sample(batch_size=args.batch_size,
