...
def vgg16(num_classes, number_net):
    model = VGG(depth=16, num_classes=num_classes, number_net=number_net)
    return model

def vgg19(num_classes, number_net):
    model = VGG(depth=19, num_classes=num_classes, number_net=number_net)
    return model
